...
#### 13.1.1 태블릿·모바일 카드 비율 조정

- [x] UI-008 | 담당 Codex | 상태 DONE | 의존 사용자 브라우저 주석 | 완료 조건: R4 드래프트 풀과 보유 카드 크기를 반응형으로 조정하고, 모바일 풀은 8열×2행, 보유 카드는 한 줄이며, 태블릿에서 과도하게 확대되지 않고 넘침이 없음을 확인한다 | 증거: 820×1180에서 풀·보유 카드 64×93px; 393×852에서 풀 16장 8열×2행, 보유 카드 4장 모두 한 줄, 양쪽 카드 약 42×61px; 모바일 문서 가로·세로 스크롤 없음.

## 14. R2 전용 RUN IT TWICE 매칭 로딩 화면

### 14.1 양쪽 RUN별 패·승률 프리뷰
