...
- 다음 드래프트에는 부족한 카드 수 그대로 참가합니다. 구매 불가 타임아웃은 구매 없이 차례를 넘기며, R2의 3장을 채우지 못한 경우 두 RUN 모두 몰수패합니다. R5 카드 부족도 순위 보상과 핸드 점수 없이 정산합니다.
...
R2와 R4에서는 공용 카드 드래프트를 먼저 진행합니다. R2는 드래프트 뒤 별도 개인 상점이 없고, R4는 16장 드래프트 뒤 개인 상점 단계까지 진행합니다.
...
- R5 진출자는 최종 총점으로 1~4위를 정합니다. R4 탈락자는 탈락 당시 승점순으로 5~6위, R3 탈락자는 탈락 당시 승점순으로 7~8위를 고정합니다. 같은 탈락 라운드에서 승점까지 같으면 플레이어 ID로만 결정론적 표시 순서를 정하며 BB·족보는 해당 순위대를 뒤집지 않습니다.
