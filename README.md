...
| **R4** | Best Five of Ten | 5장 | 공개 드래프트 → 1차전 → 승자조 / 생존조 | 생존조 패자 2명 (6 → 4) |
...
| R3 | +4P | +2P | 경기당 |
| R4 | 1차전 +10P | 1차전 +5P | 승자조 1위 +5P · 생존조 생존 +2P |
...
- **진행 보장:** 단계마다 제한 시간이 있고(상점 60초 · 결과 180초 · 기타 30초), 시간이 지나면 AI가 남은 좌석을 대신 진행해 한 명이 방을 멈출 수 없습니다.
