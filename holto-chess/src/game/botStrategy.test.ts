...
import { bestBotSelection, bestRunLoadout, rankBotPurchases, scoreBotPlan } from "./botStrategy";
...
const player = (overrides: Partial<PlayerState> = {}): PlayerState => ({
  ...
  purchasesThisRound: 0, rerollsUsed: 0, shopLocked: false, points: 0, winStreak: 0, loseStreak: 0, eliminated: false,
  ...overrides,
});
...
describe("strategic bot planner", () => {
  ...
  it("values completed R5 made hands", () => {
