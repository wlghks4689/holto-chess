...
const GUIDES: Record<Round, Guide> = {
  1: { kicker: "TEXAS HOLD'EM · SWISS 3 MATCHES", title: "Classic Hold'em", summary: "1라운드 : 2장의 카드로 커뮤니티 보드와 조합하여 더 높은 플레이어가 승리하는 클래식 홀덤", steps: ["기본으로 지급하는 카드 1장과 상점에 등장하는 카드 중 1장을 구매하여 총 2장의 카드를 사용합니다.", "2장의 핸드로 3경기를 SWISS 스테이지로 진행", "2장의 카드와 커뮤니티 보드를 조합하여 BEST 5를 만들어 승패를 결정"], scoring: "승리 +3 Point · Split +1 Point · 패배 +0 Point", caution: "텍사스 홀덤 규칙으로 승부합니다. 첫 경기는 무작위로 매칭하고, 이후에는 비슷한 성적의 상대와 대결하는 스위스 대진 방식으로 진행합니다." },
  2: { kicker: "OPEN DRAFT · SPLIT HAND", title: "RUN IT TWICE", summary: "세 장의 홀카드 중 대표 카드 한 장을 두 RUN에 공통으로 사용하고, RUN마다 서로 다른 보조 카드와 보드로 두 번 승부합니다.", steps: ["공개 드래프트로 3장 완성", "30초 안에 대표 카드 + RUN별 보조 카드 배치", "대표 카드 유지 · 보조 카드만 교체하여 RUN 2"], scoring: "RUN별 승리 +4P · Split +2P · 패배 +0P · 전원 생존", caution: "두 플레이어의 보유 6장을 제외한 46장으로 중복 없는 두 보드를 만듭니다. 세 장 모두 사용하며 RUN 시작 후 변경 불가. Split은 BB 0, 연승·연패 모두 초기화합니다." },
