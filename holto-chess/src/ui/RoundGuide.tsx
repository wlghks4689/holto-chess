...
const GUIDES: Record<Round, Guide> = {
  ...
  3: { kicker: "OMAHA SWISS", title: "Omaha Swiss Stage", summary: "홀카드 4장을 보유하고, 매 경기 그중 정확히 2장과 독립 보드 3장으로 Swiss 3경기를 진행합니다.", steps: ["Match 1: 누적 승점 순으로 매칭 상대 결정", "Match 2·3: Swiss Score가 가까운 상대와 대결", "홀카드 4장 중 2장 + 보드 5장 중 3장으로 BEST5"], scoring: "매치 승리 +4P · Split +2P · 3승 최대 +12P", caution: "Omaha는 홀카드 4장을 보유하고 정확히 2장, 보드에서 정확히 3장을 사용합니다." },
  4: { kicker: "OPEN DRAFT · BEST FIVE", title: "Best Five of Ten.", summary: "16장 공개 풀에서 누적 승점이 낮은 순으로 한 장씩 구매합니다. 상대의 보유 카드는 비공개입니다.", steps: ["6명 순차 드래프트 · 홀카드 5장 완성", "개인 상점 2장 · 리롤 2회 · 구매 3회", "홀 5장 + 보드 5장 중 자유 BEST5"], scoring: [
    `1차전: 승리 +${ROUND_POINTS.r4Primary.win}P · Split +${ROUND_POINTS.r4Primary.split}P`,
    `2차전 승자조: 1위 +${ROUND_POINTS.r4WinnerGroup.first}P · 2위 +${ROUND_POINTS.r4WinnerGroup.second}P · 3위 +${ROUND_POINTS.r4WinnerGroup.third}P (공동 2위 각 +${ROUND_POINTS.r4WinnerGroup.tiedSecond}P)`,
    "2차전 패자조: 승자 생존 · 패자 탈락",
  ], caution: "보유 한도는 5장입니다. 상점에서 교체 구매하려면 먼저 판매하세요. 드래프트 구매는 상점 구매 횟수와 별도입니다." },
